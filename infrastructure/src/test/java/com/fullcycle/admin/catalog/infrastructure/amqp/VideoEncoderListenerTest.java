...
public class VideoEncoderListenerTest {
    ...
    @Test
    public void givenCompletedResult_whenCallsListener_shouldCallsUseCase() throws InterruptedException {
        //given
        final var expectedId = IdUtils.uuid();
        final var expectedOutputBucket = "codeeducationtest";
        final var expectedStatus = MediaStatus.COMPLETED;
        final var expectedEncoderVideoFolder = "any-folder";
        final var expectedResourceId = IdUtils.uuid();
        final var expectedFilePath = "any-file-path";
