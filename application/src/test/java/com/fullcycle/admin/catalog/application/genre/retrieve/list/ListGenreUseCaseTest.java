...
public class ListGenreUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidQuery_whenCallsListGenre_shouldReturnGenres() {
        //given
        final var genres = List.of(Genre.newGenre("Ação", true), Genre.newGenre("Aventura", true));
    ...
    @Test
    public void givenAValidQuery_whenCallsListGenreAndGatewaysThrowsRandomError_shouldReturnError() {
        //given
